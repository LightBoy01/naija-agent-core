BEGIN;
INSERT INTO organizations (id, name, balance_kobo, is_active, status, region, sector, deployment_model, cost_per_reply, whatsapp_phone_id, timezone, onboarding_step, onboarding_data, system_prompt, config) VALUES ('aelixxr', 'Aelixxr OS', 0, true, 'ACTIVE', 'NG', 'commerce', 'SHARED', 3300, '2347072139935', 'Africa/Lagos', 'COMPLETE', NULL, NULL, '{"isMaster":true,"adminPhone":"2347042310893","botPhone":"2347072139935","adminPin":"$2b$10$8SnizQPx4r0u6W6yZIR3Hu7dkt/SYme4hPYcOthsqgtDwWwX03hki"}') ON CONFLICT (id) DO NOTHING;
